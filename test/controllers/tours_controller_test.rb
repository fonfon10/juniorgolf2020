...
class ToursControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create tour" do
    assert_difference('Tour.count') do
      post tours_url, params: { tour: { acronym: @tour.acronym, country_id: @tour.country_id, name: @tour.name, url: @tour.url } }
    end
  ...
  test "should update tour" do
    patch tour_url(@tour), params: { tour: { acronym: @tour.acronym, country_id: @tour.country_id, name: @tour.name, url: @tour.url } }

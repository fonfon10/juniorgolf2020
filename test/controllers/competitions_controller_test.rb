...
class CompetitionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create competition" do
    assert_difference('Competition.count') do
      post competitions_url, params: { competition: { status_id: @competition.status_id, tournament_id: @competition.tournament_id, user_id: @competition.user_id } }
    end
  ...
  test "should update competition" do
    patch competition_url(@competition), params: { competition: { status_id: @competition.status_id, tournament_id: @competition.tournament_id, user_id: @competition.user_id } }
